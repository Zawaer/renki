...
function Section({
  ...
  return (
    <View style={[styles.section, danger && { borderColor: colors.danger }]}>
...
const makeStyles = (colors: ThemeColors) =>
  StyleSheet.create({
    ...
    section: { borderWidth: 1, borderColor: colors.border, backgroundColor: colors.panel, borderRadius: 4, padding: 14 },
    sectionTitle: { color: colors.text, fontSize: 14, fontWeight: "600" },
    sectionDesc: { color: colors.faint, fontSize: 12, marginTop: 3 },
    ...
    saveBtn: { backgroundColor: colors.accent, borderRadius: 2, paddingHorizontal: 12, paddingVertical: 7 },
    saveBtnText: { color: colors.accentFg, fontSize: 13, fontWeight: "600" },
    statusRow: { flexDirection: "row", alignItems: "center", gap: 6, marginBottom: 10 },
    dot: { width: 7, height: 7, borderRadius: 4 },
    statusLabel: { color: colors.dim, fontSize: 12 },
    dl: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", gap: 10, borderTopWidth: 1, borderTopColor: colors.border, paddingTop: 8, marginTop: 8 },
    ...
    acctRow: { borderWidth: 1, borderColor: colors.border, borderRadius: 2, padding: 10 },
    acctHead: { flexDirection: "row", alignItems: "center", gap: 8 },
    acctEmail: { color: colors.text, fontSize: 13, flex: 1 },
    acctMeters: { marginTop: 8, marginLeft: 15, gap: 4 },
    acctNa: { color: colors.faint, fontSize: 11, marginLeft: 15, marginTop: 4 },
    rotation: { marginTop: 12, borderTopWidth: 1, borderTopColor: colors.border, paddingTop: 10, gap: 8 },
    thresholdInput: {
      backgroundColor: colors.bg,
      borderColor: colors.border,
      borderWidth: 1,
    ...
    divider: { marginTop: 12, borderTopWidth: 1, borderTopColor: colors.border, paddingTop: 10 },
    addAccount: { marginTop: 10, borderWidth: 1, borderColor: colors.border, borderRadius: 2, backgroundColor: colors.panel2, padding: 10, gap: 8 },
    tokenInput: {
      backgroundColor: colors.bg,
      borderColor: colors.border,
      borderWidth: 1,
    ...
    pairBtn: { flexDirection: "row", alignItems: "center", gap: 6, alignSelf: "flex-start" },
    pairBtnText: { color: colors.accent, fontSize: 13, fontWeight: "600" },
    dangerBtn: { backgroundColor: colors.danger, borderRadius: 2, paddingVertical: 10, paddingHorizontal: 16, alignSelf: "flex-start" },
