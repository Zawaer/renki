...
const makeStyles = (colors: ThemeColors) =>
  StyleSheet.create({
    ...
    tileValue: { color: colors.text, fontSize: 17, fontWeight: "600", marginTop: 2 },
    section: { gap: 8 },
    ...
    chartCard: { borderWidth: 1, borderColor: colors.border, backgroundColor: colors.panel, borderRadius: 4, padding: 12 },
    chartTitle: { color: colors.faint, fontSize: 11, fontWeight: "600", marginBottom: 8 },
    ...
    barSeg: { width: "100%", borderRadius: 2 },
    barZero: { width: "100%", height: 1 },
    barAxis: { flexDirection: "row", borderTopWidth: 1, borderTopColor: colors.border, paddingTop: 4, marginTop: 4 },
    ...
    repoTrack: { flex: 1, height: 14, flexDirection: "row", borderRadius: 2, overflow: "hidden", backgroundColor: colors.bg },
    repoValue: { width: 64, textAlign: "right", color: colors.faint, fontSize: 11 },
    tableWrap: { borderWidth: 1, borderColor: colors.border, borderRadius: 4 },
    tableHeadRow: { flexDirection: "row", backgroundColor: colors.panel2 },
    tableHeadCell: { color: colors.faint, fontSize: 10, fontWeight: "600", paddingHorizontal: 8, paddingVertical: 6 },
    tableRow: { flexDirection: "row" },
    tableCell: { color: colors.faint, fontSize: 11, paddingHorizontal: 8, paddingVertical: 5, textAlign: "right" },
    tableCellFirst: { color: colors.text, textAlign: "left" },
    note: { borderWidth: 1, borderColor: colors.border, backgroundColor: colors.panel, borderRadius: 4, padding: 12 },
