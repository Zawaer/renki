...
/**
 * Renki's mark: a stalk of grain, the same shape as the app icon and favicon
 * (generated by assets-src/make-mark.py). Inherits `currentColor`, so a caller
 * decides whether it's dark-on-amber in a tile or amber on the page.
 */
export function RenkiMark({ className = "" }: { className?: string }) {
  return (
    <svg viewBox="101 96 310 334" fill="currentColor" aria-hidden="true" className={className}>
      <rect x="244.0" y="240" width="24" height="190" rx="12.0" />
      <path d="M256 236 C290.0 166.0 290.0 126.8 256 96 C222.0 126.8 222.0 166.0 256 236 Z" />
      <path d="M256 304 C290.0 234.0 290.0 194.8 256 164 C222.0 194.8 222.0 234.0 256 304 Z" transform="rotate(60 256 304)" />
      <path d="M256 304 C290.0 234.0 290.0 194.8 256 164 C222.0 194.8 222.0 234.0 256 304 Z" transform="rotate(-60 256 304)" />
      <path d="M256 248 C290.0 178.0 290.0 138.8 256 108 C222.0 138.8 222.0 178.0 256 248 Z" transform="rotate(60 256 248)" />
      <path d="M256 248 C290.0 178.0 290.0 138.8 256 108 C222.0 138.8 222.0 178.0 256 248 Z" transform="rotate(-60 256 248)" />
      <path d="M256 192 C290.0 122.0 290.0 82.8 256 52 C222.0 82.8 222.0 122.0 256 192 Z" transform="rotate(60 256 192)" />
      <path d="M256 192 C290.0 122.0 290.0 82.8 256 52 C222.0 82.8 222.0 122.0 256 192 Z" transform="rotate(-60 256 192)" />
    </svg>
  );
}
